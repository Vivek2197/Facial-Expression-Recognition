...
#load the image file
face_image = face_recognition.load_image_file('E:/Face Recognition using Deep Learning with python/images/samples/chandu.jpeg')
...
#show the image
pil_image.save("E:/Face Recognition using Deep Learning with python/images/samples/chandu.jpeg")